...
from .views import ScheduleViewset, create_schedule, create_schedule2, list_schedules, list_user_schedules, create_availability, list_availabilities, list_user_availabilities, create_schedules_auto, delete_availability, approve_schedule, update_availability, list_team_meetings, create_team_meetings
...
urlpatterns = [
    ...
    path('meetings/create', create_team_meetings, name='create_team_meetings'),
